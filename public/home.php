...
<body>
    ...
    <div class="container main">
        <div class="row">
            ...
            <!-- This first div is the container for all listings -->
            <div class="col-xs-12 col-md-8 col-lg-8 listing-landing">
            <!-- Columns of text below the carousel -->
            <? foreach($ads as $id => $ad): ?>
                <div class="col-xs-12 col-md-6 col-lg-6 listing">
    ...
    <div class="col-xs-12 col-md-offset-4 col-md-8 col-md-offset-4 col-lg-8">            
    <nav>
        <ul class="pager">
            <? if ($totalListings >= $items_per_page) : ?>        
                <? if ($page > 1) : ?>
                    <li class="previous"><a href="?<? if (isset($catString)) { echo $catString; }?>page=1" class="btn btn-link">First Page</a></li>
                    <li class="previous"><a href="?<? if (isset($catString)) { echo $catString; }?>page=<?= $pageDown; ?>" class="btn btn-link">Previous</a></li>
                <? endif; ?>
                <? if ($page < $lastPage) : ?>
                    <li class="next"><a href="?<? if (isset($catString)) { echo $catString; }?>page=<?= $pageUp; ?>" class="btn btn-link">Next</a></li> 
                    <li class="next"><a href="?<? if (isset($catString)) { echo $catString; }?>page=<?= $lastPage; ?>" class="btn btn-link">Last Page</a></li>
                <? endif; ?>
            <? endif; ?>
        </ul>
    </nav>
